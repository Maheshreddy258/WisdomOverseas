...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.SearchHolder> implements Filterable {
    ...
    public SearchAdapter(Context mContext, List<NewAllCallsResponse> allCallsResponseList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull SearchAdapter.SearchHolder searchHoldeer, final int i) {
